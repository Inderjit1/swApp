...
class HomepageViewController: UIViewController, UITextFieldDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        // This section adds a background image to the homepage public scroll feed (replace with SJSU image)
        /*let image = UIImageView()
        image.image = UIImage(named:"home-7.png")
    ...
    */
    ...
    @objc func dropDown(){
      slideinmenubar.homepageviewcontroller = self
      slideinmenubar.slidedropDown()
    }
    
    func navigationFromSlideInMenu(selecteditem: menubarItem){
        ...
        case "Settings":
            ...
            self.navigationController?.pushViewController(vc!, animated: true)
        default:
            print("Error - Illegal Button selection")
        }
        /*
       let vc = self.storyboard?.instantiateViewController(withIdentifier: "Account")
      // self.present(vc!, animated: true, completion: nil)
      // let vc = self.storyboard?.instantiateViewController(withIdentifier: "AccountNavigation") as! UINavigationController
